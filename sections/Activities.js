...
const atividades = [
  ...
  { title: 'Workshop Web Development', data: '7 de dezembro', horas:'18h00', local: 'Google Meet', orador: '', organizador: 'CeSIUM', body: 'Workshop em que, numa primeira parte, o/a orador/a apresenta os fundamentos de HTML e CSS de uma forma mais teórica. A segunda parte consiste numa aplicação prática dos conceitos abordados, na qual será criada uma simples página usando os conhecimentos adquiridos.', image: '/images/Ativities/Workshop_WebD.svg' },
  { title: 'Guião Gloss', data: '8 de dezembro', horas:'21h00', local: 'Youtube', orador: 'Filipe Felício', organizador: 'CeSIUM', body: 'Vídeos que irão exemplificar o uso da ferramenta juntamente com slides explicativos para poderem ser consultados futuramente.', image: '/images/Ativities/Guiao_Gloss.svg' },
  { title: 'Hour of Code', data: '13 de dezembro', horas:'18h00', local: 'Google Meet', orador: '', organizador: 'CeSIUM', body: 'Atividade em que introduzimos os conceitos da programação e como devem ser usados. Para tal, serão apresentados alguns desafios para assimilar os conteúdos abordados.', image: '/images/Ativities/Hour_of_code.svg' },
  { title: 'Revisão do Projeto de CP', data: '14 de dezembro', horas:'TBA', local: 'TBA', orador: '', organizador: 'CeSIUM', body: 'Atividade onde estudantes mais experientes que já fizeram a unidade curricular revêem projetos de anos anteriores com os alunos atualmente inscritos.', image: '/images/Ativities/Revisao-Projeto-CP.svg' },
