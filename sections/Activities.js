...
const atividades = [
  ...
  { title: 'Guião Gloss', data: '6 de dezembro', horas:'21h00', local: 'Youtube', orador: 'Filipe Felício', organizador: 'CeSIUM', body: 'Vídeos que irão exemplificar o uso da ferramenta juntamente com slides explicativos para poderem ser consultados futuramente.', image: '/images/Ativities/Guiao_Gloss.svg' },
  ...
  { title: 'Hour of Code', data: '13 de dezembro', horas:'18h00', local: 'Google Meet', orador: '', organizador: 'CeSIUM', body: 'Atividade em que introduzimos os conceitos da programação e como devem ser usados. Para tal, serão apresentados alguns desafios para assimilar os conteúdos abordados.', image: '/images/Ativities/Dezembro_Solidário_TBA.svg' },
  { title: 'Revisão do Projeto de CP', data: '14 de dezembro', horas:'TBA', local: 'TBA', orador: '', organizador: 'CeSIUM', body: 'Atividade onde estudantes mais experientes que já fizeram a unidade curricular revêem projetos de anos anteriores com os alunos atualmente inscritos.', image: '/images/Ativities/Dezembro_Solidário_TBA.svg' },
  { title: 'Torneio de Brawlhalla', data: '17 de dezembro', horas:'TBA', local: 'Discord CeSIUM', orador: '', organizador: 'CeSIUM', body: `Torneio num "fighting plataform" onde poderás competir em equipas de 2, sendo que pelo menos um dos partecipantes tem de pertencer à universade do Minho.`, image: '/images/Ativities/Dezembro_Solidário_TBA.svg' },
]
