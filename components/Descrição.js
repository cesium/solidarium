...
export default function Descrição() {
  return(
    <div className="h-full px-6 py-40 my-auto bg-white sm:px-20 lg:px-64">
      <div className="flex flex-col items-center w-full">
        <div className="mb-10 ">
          <h1 className="text-3xl text-center sm:text-4xl font-code_regular text-primary">O que é o Dezembro Solidário?</h1>
        </div>
